package com.dsu_review_api.service;
...
public class ReviewPostServiceTest {
    ...
    void addPostTest(){
        ...
        request.put("likes", 0);
        request.put("user_number", "20191434");
        request.put("lec_name", "경찰행정학");
        request.put("star_lating", 4L);
...
//        postList.get(0)
    ...
    void deletePostTest(){
        ...
        reviewPostService.deletePost(jsonObject);
